        ...
        <div className="my-4 p-8 shadow-lg round-lg">
            <form onSubmit={submitPost}>
                ...
                <div className="py-2">
                    ...
                    <p className={`text-cyan-600 font-medium text-small ${post.description.length > 50 ? 'text-red-600' : ''}`}>{post.description.length}/1000</p>
                    ...
                    <p className={`text-cyan-600 font-medium text-small ${post.description.length > 1000 ? 'text-red-600' : ''}`}>{post.description.length}/1000</p>
                </div>
                <button 
                type="submit"
