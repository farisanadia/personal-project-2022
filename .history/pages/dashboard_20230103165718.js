            ...
            <div className="space-y-2">
                {posts.map(post => {
                    ...
                    <Message {...post} key={post.id}>
                        ...
                        >
                        <Menu.Items className="absolute flex right-0 z-10 mt-2 w-38 origin-top-right rounded-md p-2 bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                            <div className="py-1">
                                <Menu.Item>
                                    {({ active }) => (
