    ...
    return (
        <div>
            ...
            <form onSubmit={sendChat} className="py-2 flex">
                <input value={chat.text} className="border-1 rounded-lg px-4 py-1 bg-gray-800 w-full" onChange={(e) => setChat({ ...chat, text: e.target.value})} placeholder="say something nice"/>
