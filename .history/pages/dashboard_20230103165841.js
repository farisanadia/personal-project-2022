                            ...
                            <div className="py-1">
                                <Menu.Item>
                                    {({ active }) => (
                                        ...
                                        className={`'items-center block px-4 py-2 text-sm ${active ? 'bg-gray-100 text-gray-900' : 'text-gray-700'}`}>
                                            <BsTrash2Fill className="inline-flex px-1 items-center text-l"/>
                                            Delete
                                        </button>
                                    )}
                                </Menu.Item>
