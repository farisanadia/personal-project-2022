import { collection, getDoc, getDocs, query, serverTimestamp, setDoc, updateDoc, where } from "firebase/firestore";
...
export default function Search() {
    ...
    const handleSelect = async() => {
        ...
        try {
            const chatRef = query(collection(db, 'chats'), where(document))
