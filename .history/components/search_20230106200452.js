...
export default function Search() {
    ...
    const checkUser = async() => {
        if (loading) return;
        if (!currentUser) return route.push("./pages/auth/login");
    }
    ...
    return(
        <div className="bg-gray-800 border-b-2 border-gray-300">
            <div className="p-2">
                <h2 className="text-gray-400">SAFARI Chat</h2>
                <img className="rounded-lg w-5" src={auth.currentUser.photoURL} alt=""/>
            </div>
            <div>
