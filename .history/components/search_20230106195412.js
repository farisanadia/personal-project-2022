...
export default function Search() {
    ...
    return(
        <div className="bg-gray-800 border-b-2 border-gray-300 w-1/3">
            <div>
                <input type="text" placeholder="find a user" onKeyDown={handleKey} 
                onChange={(e) => setUsername(e.target.value)} value={username} className="bg-cyan-600 text-white p-2 text-sm"/>
            </div>
